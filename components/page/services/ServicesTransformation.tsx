...
const ServicesTransformation: FC = () => {
  const lang = useCurrentLanguages();
  const { heading, subheading, before, after } =
    servicesContents[lang].transformation;
    ...
    >
      <div className="flex flex-col gap-[clamp(48px,calc(((100vw-1024px)/896*48)+48px),88px)]">
        <header className="max-w-[min(720px,100%)]">
          ...
          <p className="mt-6 font-acumin-wide-light text-brand-text-muted text-[clamp(15px,calc(((100vw-1024px)/896*2)+15px),17px)] leading-[1.65]">
            {subheading}
          </p>
        </header>

        <div className="grid grid-cols-[1fr_auto_1fr] lg:grid-cols-1 gap-[clamp(24px,calc(((100vw-1024px)/896*32)+24px),48px)] items-stretch">
