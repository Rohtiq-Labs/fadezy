...
const ScrollingParallax: FC<Props> = ({}) => {
    ...
    const headlinePinVars = useMemo(() => ({
        start: () => "center center" as const,
        end: () => "center center" as const,
        toggleActions: "play none none reverse" as const,
        scrub: 0,
        pinType: "transform" as const
    }), []);

    const fadeInVars = useMemo(() => ({
        start: () => "top bottom" as const,
        end: () => "bottom bottom" as const,
        scrub: 0
    }), []);

    const img1Vars = useMemo(() => ({
        start: () => "center bottom" as const,
        end: () => "bottom+=150vh bottom" as const,
        scrub: 0
    }), []);

    const img2Vars = useMemo(() => ({
        start: () => "center bottom" as const,
        end: () => "bottom+=100vh bottom" as const,
        scrub: 0
    }), []);

    const descVars = useMemo(() => ({
        start: () => "top bottom" as const,
        end: () => "center bottom" as const,
        scrub: 0
    }), []);

    const phoneTransformVars = useMemo(() => ({
        start: () => "center bottom" as const,
        end: () => "center+=100vh bottom" as const,
        scrub: 0
    }), []);

    const phoneImgVars = useMemo(() => ({
        start: () => "center bottom" as const,
        end: () => "center+=100vh bottom" as const,
        scrub: 0
    }), []);
        ...
        <div className='w-full'>
            <div className='flex w-full justify-center items-center text-center min-h-[calc(var(--dvh)*80)]' ref={headlineContainerRef}>
                <CustomScrollAnimation
                        ...
                        scrollTriggerVars={headlinePinVars}
                >
               ...
               <CustomScrollAnimation 
                ...
                <div className='w-full flex justify-center  ' >
                    ...
                    <CustomScrollAnimation 
                        ...
                        ease={"none"}
                        trigger={"self"}
                        scrollTriggerVars={phoneTransformVars}
                    >
                        ...
                        <CustomScrollAnimationImage 
                            ...
                            ease={"none"}
                            trigger={"self"}
                            scrollTriggerVars={phoneImgVars}
                            className=' object-cover'
                        />
